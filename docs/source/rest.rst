...
blackdagger server provides simple APIs to query and control workflows.

See the `OpenAPI Schema for blackdagger <https://github.com/ErdemOzgen/blackdagger/blob/main/swagger.yaml>`_ for more details.
