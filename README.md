...
- Web User Interface
- Command Line Interface (CLI) with several commands to run and manage DAGs
- YAML format to define DAGs, with support for various features, including:
  ...
  - Repeating tasks
  - Automatic retry
- Executors to run different types of tasks:
...
Each component is designed to be interoperable, enabling seamless operation across any environment, for any use case, with maximum ease, speed, and efficiency. The framework supports adding, removing, or modifying components to incorporate new features for additional purposes.

As Blackdagger forms the core, this repository provides comprehensive details about the framework's capabilities. For more information on individual components, please refer to their respective repositories.
